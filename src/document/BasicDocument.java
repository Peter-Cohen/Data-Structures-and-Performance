...
public class BasicDocument extends Document {
  ...
  public int getNumSyllables() {
    ...
    /*
     * List<String> tokens = getTokens("[aeiouyAEIOUY]+"); List<String> loneEs =
     * getTokens("[^aeiouyAEIOUY]+[eE]\\b"); List<String> singleEs =
     * getTokens("\\b[^aeiouyAEIOUY]*[eE]\\b");
     * 
     * 
  ...
  public static void main(String[] args) {
    ...
    testCase(
        new BasicDocument("This is a test.  How many???  Senteeeeeeeeeences are here... there should be 5!  Right?"),
        16, 13, 5);
    testCase(new BasicDocument(""), 0, 0, 0);
    testCase(new BasicDocument("sentence, with, lots, of, commas.!  (And some poaren)).  The output is: 7.5."), 15, 11,
        4);
