...
public class EfficientDocument extends Document {
   ...
   * string of alphabetic characters i.e. any upper or lower case characters a-z
   * or A-Z. This method completely ignores numbers when you count words, and
   * assumes that the document does not have any strings that combine numbers and
   * letters.
   * 
   * Check the examples in the main method below for more information.
   * 
   ...
   * calculate the the number of syllables in a word, it uses the following rules:
  ...
  public static void main(String[] args) {
    ...
    testCase(new EfficientDocument("sentence, with, lots, of, commas.!  " + "(And some poaren)).  The output is: 7.5."),
        15, 11, 4);
