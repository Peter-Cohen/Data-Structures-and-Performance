...
public class NearbyWords implements SpellingSuggest {
	...
	/*
	 * basic testing code to get started String word = "i"; // Pass NearbyWords any
	 * Dictionary implementation you prefer Dictionary d = new DictionaryHashSet();
	 * DictionaryLoader.loadDictionary(d, "data/dict.txt"); NearbyWords w = new
	 * NearbyWords(d); List<String> l = w.distanceOne(word, true);
