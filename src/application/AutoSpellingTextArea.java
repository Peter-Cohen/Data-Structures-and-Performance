...
public class AutoSpellingTextArea extends StyledTextArea<Boolean> {
    ...
    /**
     * Gets white space delimited word which contains character at pos in text Also
    ...
    /**
     * Returns a boolean array with true in position where word has an upper case
     * letter
     * 
     * @param word
